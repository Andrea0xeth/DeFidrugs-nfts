...
contract DeFiDrugs is ERC721URIStorage {
  ...
  string[] firstWords = ["Salumi", "Soute", "Frittura", "Taralli", "Olive", "Insalata"];
        ...
        bytes(
            string(
                abi.encodePacked(
                    ...
                    combinedWord,
                    '", "description": "La tua Cena.", "image": "data:image/svg+xml;base64,',
